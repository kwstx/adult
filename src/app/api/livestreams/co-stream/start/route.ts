...
/**
 * POST /api/livestreams/co-stream/start
 * 
 * Primary host launches the multi-creator broadcast, provisioning SFU media rooms.
 */
export const POST = apiHandler(async (req, ctx) => {
  ...
  const result = await CoStreamService.startBroadcast(hostCreatorId, sessionId);
